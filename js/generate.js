...
let boyfirst = ["Тупой", "Конченный", "Ебанутый", "Хуевый", "Пизданутый", "Шизанутый", "Уебищный", "Умерший", "Ауфный", "Жопный"];
let boysec = ["Даун", "Еблан", "Пидорас", "Хуйлан", "Говноед", "Конч", "Шизик", "Гопник", "Ауешник", "Хуй"];

let girlfirst = ["Тупая", "Конченная", "Ебанутая", "Некрасивая", "Выебаная", "Жирная", "Токсичная", "Обтраханная", "Ебаная", "Задротская", "Горбатая"];
let girlsec = ["Хуйня", "Залупа", "Манда", "Шлюха", "Прошманда", "Блядь", "Хуила", "Сосалка", "Пидораска", "Ебланка"];
